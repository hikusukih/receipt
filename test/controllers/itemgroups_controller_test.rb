...
class ItemgroupsControllerTest < ActionController::TestCase
  ...
  test "should create itemgroup" do
    assert_difference('Itemgroup.count') do
      post :create, itemgroup: { group_id: @itemgroup.group_id, grouptype_id: @itemgroup.grouptype_id, item_id: @itemgroup.item_id }
    end
  ...
  test "should update itemgroup" do
    patch :update, id: @itemgroup, itemgroup: { group_id: @itemgroup.group_id, grouptype_id: @itemgroup.grouptype_id, item_id: @itemgroup.item_id }
    assert_redirected_to itemgroup_path(assigns(:itemgroup))
  end
